  ...
  <div>
    ...
    <Container sm>
      ...
      <Text>
        ...
        Bible, et pour s’encourager mutuellement dans la foi. En tant que
        chrétiens, nous affirmons donc notre attachement à Jésus-Christ, qui est
        pleinement homme et pleinement Dieu, et nous le reconnaissons comme
        étant le seul Chef de l’Église. En communion avec tous les autres
        chrétiens de l’histoire, nous nous reconnaissons dans les déclarations
        de foi des premiers siècles (dites “œcuméniques”), que sont notamment le
        Crédo (ou “Symbole des Apôtres”), le Symbole de Nicée, et le Symbole dit
        “d’Athanase”.
      </Text>
    </Container>
    ...
    <Container sm>
      ...
      <Text>
        ...
        spéciale, infaillible et suffisante de Dieu. Ce mouvement de réforme a
        été très influent en Europe au XVIe siècle, avant d’être confronté, dans
        certains pays comme la France, à une violente opposition. Notre église
        s’inscrivant dans la continuité historique de ce mouvement, nous
        affirmons à notre tour notre attachement à la Bible comme ultime
        autorité en matière de foi et de vie.
      </Text>
    </Container>
    ...
    <Container sm>
      ...
      <Text>
        ...
        églises protestantes du XVIe siècle. Ainsi, en tant qu’église réformée,
        nous affirmons notre attachement aux principes de la réforme calviniste
        et aux confessions de foi historiques, comme la Confession de foi de La
        Rochelle (1559), le Catéchisme de Heidelberg (1563), les Canons de
        Dordrecht (1619), et particulièrement la Confession de foi de
        Westminster (1647).
      </Text>
    </Container>
