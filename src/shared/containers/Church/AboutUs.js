    ...
    <RevealQueue delay={0.2} offset={100}>
      <Container sm>
        ...
        <Typography paragraph>
          ...
          assemblées locales (aussi appelées “paroisses”, ou “églises” avec un
          “e” minuscule), pour célébrer un culte à Dieu, pour s’instruire dans
          la Bible, et pour s’encourager mutuellement dans la foi.
        </Typography>
        <Typography paragraph>
          ...
          les déclarations de foi des premiers siècles (dites “œcuméniques”),
          que sont notamment le Crédo (ou “Symbole des Apôtres”), le Symbole de
          Nicée, et le Symbole dit “d’Athanase”.
        </Typography>
      </Container>
      ...
      <Container sm>
        ...
        <Typography paragraph>
          ...
          (protestare en latin) l’enseignement inaltéré de la Bible, considérée
          comme révélation spéciale, infaillible et suffisante de Dieu.
        </Typography>
        <Typography paragraph>
      ...
      <Container sm>
        ...
        <Typography paragraph>
          ...
          dite “protestante” est devenue très diverse en termes de sensibilités
          et même de doctrines sur des points non-essentiels. Dans le même
          temps, l’appellation “réformée” a été retenue par les églises qui
      ...
      <Container sm>
        ...
        <Typography paragraph>
          ...
          d’avoir une relation personnelle avec Dieu. Elles cherchent à diffuser
          autant que possible la bonne nouvelle qui concerne la personne et
          l’œuvre de Jésus-Christ. Celui-ci est venu de la part de Dieu pour
          mourir sur la croix (prenant sur lui le poids des fautes de tous les
          croyants) et pour ressusciter le troisième jour (triomphant ainsi du
          mal et de la mort).
        </Typography>
        <Typography paragraph>
          En tant qu’église évangélique, nous affirmons que tous ceux qui se
          confient en Jésus pour le pardon de leurs fautes (appelées “péchés”
          dans la Bible) sont assurément réconciliés avec Dieu pour l’éternité ;
          nous cherchons à vivre une relation authentique et personnelle avec
